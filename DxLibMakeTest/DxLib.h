...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x322f
#define DXLIB_VERSION_STR_T _T( "3.22f" )
#define DXLIB_VERSION_STR_W    L"3.22f"
...
extern	int				GetTouchInput( int InputNo, int *PositionX, int *PositionY, int *ID DEFAULTPARAM( = NULL ) , int *Device DEFAULTPARAM( = NULL ) ) ;		// タッチの情報を取得する
