...
#endif // BUMPMAP
	float2 Fog_ShadowMap2PosZ             : TEXCOORD5 ;	// フォグパラメータ( x )とシャドウマップ２のライト座標( y )
...
//	float4		variance_md_p_pmax ;
	...
	TotalSpecular = 0.0f ;
		...
		if( PSInput.ShadowMap0Pos_ShadowMap2PosX.w < -1.0f || PSInput.ShadowMap0Pos_ShadowMap2PosX.w > 1.0f ||
		    ...
		    PSInput.Fog_ShadowMap2PosZ.y           <  0.0f || PSInput.Fog_ShadowMap2PosZ.y           > 1.0f )
		{
			ShadowRate.z = 1.0f;
		}
		else
		{
			...
			// テクスチャに記録されている深度( +補正値 )よりＺ値が大きかったら奥にあるということで減衰率を最大にする
			ShadowRate.z = smoothstep( PSInput.Fog_ShadowMap2PosZ.y - g_ShadowMap.Data[ 2 ].GradationParam, PSInput.Fog_ShadowMap2PosZ.y, TextureDepth.r + g_ShadowMap.Data[ 2 ].AdjustDepth ) ;
		}
	#else // SHADOWMAP
		ShadowRate.x = 1.0f ;
		ShadowRate.y = 1.0f ;
...
// ライト0の処理 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++( 開始 )
	...
	// 距離・スポットライト減衰値計算 =======================================( 開始 )
		...
		lLightGen *= step( lLightDistancePow2, g_Common.Light[ 0 ].Range ) ;
...
// ライト1の処理 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++( 開始 )
	...
	// 距離・スポットライト減衰値計算 =======================================( 開始 )
		...
		// 有効距離外だったら減衰率を最大にする処理
		lLightGen *= step( lLightDistancePow2, g_Common.Light[ 1 ].Range ) ;
...
// ライト2の処理 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++( 開始 )
	...
	// 距離・スポットライト減衰値計算 =======================================( 開始 )
		...
		// 有効距離外だったら減衰率を最大にする処理
		lLightGen *= step( lLightDistancePow2, g_Common.Light[ 2 ].Range ) ;
...
// ライト3の処理 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++( 開始 )
	...
	// 距離・スポットライト減衰値計算 =======================================( 開始 )
		...
		// 有効距離外だったら減衰率を最大にする処理
		lLightGen *= step( lLightDistancePow2, g_Common.Light[ 3 ].Range ) ;
...
// ライト4の処理 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++( 開始 )
	...
	// 距離・スポットライト減衰値計算 =======================================( 開始 )
		...
		// 有効距離外だったら減衰率を最大にする処理
		lLightGen *= step( lLightDistancePow2, g_Common.Light[ 4 ].Range ) ;
...
// ライト5の処理 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++( 開始 )
	...
	// 距離・スポットライト減衰値計算 =======================================( 開始 )
		...
		// 有効距離外だったら減衰率を最大にする処理
		lLightGen *= step( lLightDistancePow2, g_Common.Light[ 5 ].Range ) ;
...
// ライト5の処理 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++( 終了 )
	...
	// フォグ効果
	PSOutput.Color0.rgb = lerp( g_Common.Fog.Color.rgb, PSOutput.Color0.rgb, saturate( PSInput.Fog_ShadowMap2PosZ.x ) );
