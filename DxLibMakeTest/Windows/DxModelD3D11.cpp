...
//	}
	...
	case DX_BLENDMODE_NOBLEND :
		Graphics_D3D11_DeviceState_SetBlendMode( BlendMode, MV1Man.DrawMode != DX_MV1_DRAWMODE_NORMAL_DEPTH && GSYS.DrawSetting.NotWriteAlphaChannelFlag ? TRUE : FALSE ) ;
		break ;

	case DX_BLENDMODE_SUB :
		Graphics_D3D11_DeviceState_SetBlendMode( DX_BLENDMODE_SUB1, GSYS.DrawSetting.NotWriteAlphaChannelFlag ) ;
		break ;

	case DX_BLENDMODE_ALPHA :
		if( Frame->Container->UseDrawMulAlphaColor )
		{
			Graphics_D3D11_DeviceState_SetBlendMode( DX_BLENDMODE_PMA_ALPHA, GSYS.DrawSetting.NotWriteAlphaChannelFlag ) ;
		}
		else
		{
			Graphics_D3D11_DeviceState_SetBlendMode( DX_BLENDMODE_ALPHA, GSYS.DrawSetting.NotWriteAlphaChannelFlag ) ;
		}
		break ;
	...
	case DX_BLENDMODE_ADD :
		if( Frame->Container->UseDrawMulAlphaColor )
		{
			Graphics_D3D11_DeviceState_SetBlendMode( DX_BLENDMODE_PMA_ADD, GSYS.DrawSetting.NotWriteAlphaChannelFlag ) ;
		}
		else
		{
			Graphics_D3D11_DeviceState_SetBlendMode( DX_BLENDMODE_ADD, GSYS.DrawSetting.NotWriteAlphaChannelFlag ) ;
		}
		break ;
	}
